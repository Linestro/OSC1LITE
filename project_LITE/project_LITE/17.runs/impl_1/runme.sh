...
HD_PWD='C:/Users/yoongroup/Documents/Adam/vivado/project_LITE/project_LITE/17.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log OSC1_LITE_Control.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source OSC1_LITE_Control.tcl -notrace
