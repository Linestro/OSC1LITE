...
HD_PWD='C:/Users/yoongroup/Documents/Adam/vivado/project_LITE/project_LITE/17.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log OSC1_LITE_Control.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source OSC1_LITE_Control.tcl
