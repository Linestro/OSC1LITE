...
#
# Generated by Vivado on Sat Jan 05 14:58:10 -0500 2019
...
copy_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="C:/Users/yoongroup/Documents/Adam/vivado/project_LITE/17.cache/compile_simlib/activehdl"
  fi
