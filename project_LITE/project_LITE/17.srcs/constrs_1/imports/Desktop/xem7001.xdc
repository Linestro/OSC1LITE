...
## JP2-27 
#set_property PACKAGE_PIN T2 [get_ports {clear[10]}]
...
## JP2-29 
set_property PACKAGE_PIN T3 [get_ports {latch[10]}]
...
## JP2-46 
set_property PACKAGE_PIN R8 [get_ports {sdo_bit[9]}]
...
## JP3-3 
set_property PACKAGE_PIN A8 [get_ports {sdo_bit[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {sdo_bit[4]}]

## JP3-4 
set_property PACKAGE_PIN D9 [get_ports {clear[5]}]
...
## JP3-6 
set_property PACKAGE_PIN D10 [get_ports {latch[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {latch[5]}]

## JP3-7 
set_property PACKAGE_PIN A9 [get_ports {sclk[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {sclk[4]}]

## JP3-8 
set_property PACKAGE_PIN C9 [get_ports {sclk[5]}]
...
## JP3-11 
set_property PACKAGE_PIN B9 [get_ports {latch[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {latch[4]}]

## JP3-12 
set_property PACKAGE_PIN A10 [get_ports {din[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {din[5]}]

## JP3-13 
set_property PACKAGE_PIN B10 [get_ports {clear[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {clear[4]}]

## JP3-14 
set_property PACKAGE_PIN C11 [get_ports {sdo_bit[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {sdo_bit[5]}]

## JP3-15 
set_property PACKAGE_PIN B12 [get_ports {clear[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {clear[1]}]

## JP3-16 
set_property PACKAGE_PIN A12 [get_ports {clear[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {clear[0]}]

## JP3-17 
set_property PACKAGE_PIN C12 [get_ports {latch[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {latch[1]}]

## JP3-18 
set_property PACKAGE_PIN F13 [get_ports {latch[0]}]
...
## JP3-21 
set_property PACKAGE_PIN A13 [get_ports {sclk[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {sclk[1]}]

## JP3-22 
set_property PACKAGE_PIN A14 [get_ports {sclk[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {sclk[0]}]

## JP3-23 
set_property PACKAGE_PIN E13 [get_ports {din[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {din[1]}]

## JP3-24 
set_property PACKAGE_PIN B14 [get_ports {din[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {din[0]}]

## JP3-25 
set_property PACKAGE_PIN C14 [get_ports {sdo_bit[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {sdo_bit[1]}]

## JP3-26 
set_property PACKAGE_PIN A15 [get_ports {sdo_bit[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {sdo_bit[0]}]

## JP3-27 
set_property PACKAGE_PIN B15 [get_ports {clear[10]}]
set_property IOSTANDARD LVCMOS33 [get_ports {clear[10]}]

## JP3-28 
set_property PACKAGE_PIN B16 [get_ports {clear[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {clear[3]}]

## JP3-29 
set_property PACKAGE_PIN C16 [get_ports {latch[10]}]
set_property IOSTANDARD LVCMOS33 [get_ports {latch[10]}]

## JP3-30 
set_property PACKAGE_PIN D15 [get_ports {latch[3]}]
...
## JP3-33 
set_property PACKAGE_PIN D16 [get_ports {clear[11]}]
set_property IOSTANDARD LVCMOS33 [get_ports {clear[11]}]

## JP3-34 
set_property PACKAGE_PIN D14 [get_ports {sclk[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {sclk[3]}]

## JP3-35 
set_property PACKAGE_PIN E16 [get_ports {latch[11]}]
set_property IOSTANDARD LVCMOS33 [get_ports {latch[11]}]

## JP3-36 
set_property PACKAGE_PIN E15 [get_ports {din[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {din[3]}]

## JP3-37 
set_property PACKAGE_PIN G15 [get_ports {sclk[11]}]
set_property IOSTANDARD LVCMOS33 [get_ports {sclk[11]}]

## JP3-38 
set_property PACKAGE_PIN F14 [get_ports {sdo_bit[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {sdo_bit[3]}]

## JP3-39 
set_property PACKAGE_PIN H14 [get_ports {din[11]}]
set_property IOSTANDARD LVCMOS33 [get_ports {din[11]}]

## JP3-40 
set_property PACKAGE_PIN G16 [get_ports {clear[2]}]
...
## JP3-43 
set_property PACKAGE_PIN H13 [get_ports {sdo_bit[11]}]
set_property IOSTANDARD LVCMOS33 [get_ports {sdo_bit[11]}]

## JP3-44 
set_property PACKAGE_PIN H16 [get_ports {latch[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {latch[2]}]

## JP3-45 
set_property PACKAGE_PIN F15 [get_ports {sdo_bit[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {sdo_bit[2]}]

## JP3-46 
set_property PACKAGE_PIN G14 [get_ports {sclk[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {sclk[2]}]

# JP3-47 
set_property PACKAGE_PIN E12 [get_ports {din[2]}]
